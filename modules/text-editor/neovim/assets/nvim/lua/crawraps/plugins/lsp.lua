return {
  ...
  },
  {
    ...
    init = function()
      require('crawraps.plugins.lsp.diagnostics')
    end,
  },
  -- {
  ...
  },
  {
    ...
    event = { "BufWritePre" },
    cmd = { "ConformInfo" },
    keys = require("crawraps.plugins.lsp.formatters").keys,
    opts = require("crawraps.plugins.lsp.formatters").opts,
    init = require("crawraps.plugins.lsp.formatters").init,
  },
}
